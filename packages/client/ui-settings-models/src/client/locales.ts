...
export const en = {
  ...
  modelReasoningEfforts: 'Thinking intensity',
  modelReasoningEffortsHint: 'Levels the model is offered per request; with none, no thinking is sent.',
  modelReasoningLevelMinimal: 'Minimal',
  modelReasoningLevelLow: 'Low',
  modelReasoningLevelMedium: 'Medium',
  modelReasoningLevelHigh: 'High',
  modelReasoningLevelXhigh: 'X-High',
  modelReasoningLevelMax: 'Max',
  modelReasoningEffortsInvalid: 'Thinking intensity must be off, or name at least one level the model supports.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEfforts: '思考强度',
  modelReasoningEffortsHint: '模型每次请求可用的思考档位；不勾选则不发送任何思考档位。',
  modelReasoningLevelMinimal: '极简',
  modelReasoningLevelLow: '低',
  modelReasoningLevelMedium: '中',
  modelReasoningLevelHigh: '高',
  modelReasoningLevelXhigh: '超高',
  modelReasoningLevelMax: '满档',
  modelReasoningEffortsInvalid: '思考强度需为关闭，或声明至少一个模型支持的档位。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供商\u2026',
