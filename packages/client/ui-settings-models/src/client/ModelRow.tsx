...
interface ModelRowProps {
  ...
  /** Offer the pi-ai adapter's per-request thinking levels; the DeepSeek family never declares them. */
  reasoningLevels?: boolean | undefined
  expanded: boolean
  disabled: boolean
